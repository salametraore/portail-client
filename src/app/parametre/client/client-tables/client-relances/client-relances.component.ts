...
@Component({
  selector: 'client-relances',
  templateUrl: './client-relances.component.html',
  styleUrl: './client-relances.component.scss'
})
export class ClientRelancesComponent implements OnInit,AfterViewInit{
