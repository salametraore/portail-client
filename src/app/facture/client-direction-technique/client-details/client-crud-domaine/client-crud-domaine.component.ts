...
@Component({
  selector: 'client-crud-domaine',
  templateUrl: './client-crud-domaine.component.html'
})
export class ClientCrudDomaineComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ClientCrudDomaineComponent>,
