...
@Component({
  selector: 'client-crud-prestations-diverses',
  templateUrl: './client-crud-prestations-diverses.component.html'
})
export class ClientCrudPrestationsDiversesComponent implements OnInit, AfterViewInit {
