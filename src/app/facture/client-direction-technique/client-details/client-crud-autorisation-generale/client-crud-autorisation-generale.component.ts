...
@Component({
  selector: 'client-crud-autorisation-generale',
  templateUrl: './client-crud-autorisation-generale.component.html'
})
export class ClientCrudAutorisationGeneraleComponent implements OnInit {
