...
@Component({
  selector: 'client-crud-service-confiance',
  templateUrl: './client-crud-service-confiance.component.html'
})
export class ClientCrudServiceConfianceComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ClientCrudServiceConfianceComponent>,
  ...
  onGetClient(client: Client) {
    ...
    this.form.patchValue({ client: client.id });
  }
