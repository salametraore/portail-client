...
@Component({
  selector: 'app-facture-detail-dfc-energie',
  templateUrl: './facture-detail-dfc-energie.component.html',
  styleUrl: './facture-detail-dfc-energie.component.scss'
})
export class FactureDetailDfcEnergieComponent {
